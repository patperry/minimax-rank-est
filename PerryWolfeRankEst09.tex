...
\begin{figure*}
    \centering
%    \hspace{1cm}\subfigure{\includegraphics[width=0.396\columnwidth]{plots/sim1}}\hfill%
%    \subfigure{\includegraphics[width=0.5\columnwidth]{plots/sim2}}
%    \hspace{1cm}\subfigure{\includegraphics[width=0.792\columnwidth]{plots/sim1}}\hfill%
%    \subfigure{\includegraphics[width=\columnwidth]{plots/sim2}}
